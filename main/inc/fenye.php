    ...
    return "<nav class=\"text-center\">
  				<ul class=\"pagination\">
    				...
    				<li>".$this->nowbar('', $this->currentindexstyle)."</li>
   	 				...
   	 				<li>
   	 				<input style=\"width:50px;\" type=\"text\" name=\"pageNum\" id=\"pageNum\" length=\"3\">
   	 				<input type=\"button\" id=\"goPage\" onclick=\"javascript:" . $this->ajax_action_name . "(document.getElementById('pageNum').value);\" value=\"确定\">
   	 				</li>
  				</ul>

		</nav>";
    /*
    return "共<span class=\"pagerecord\">".$this->totalrecord."</span>记录&nbsp;共<span class=\"pagerecord\">".$this->totalpage."</span>页&nbsp; ".$this->pre_page(). "&nbsp;&nbsp;" .$this->nowbar('', $this->currentindexstyle).$this->next_page().' &nbsp;第'.$this->select().'页';
    */
    break;
   case '2':
    $this->next_page='&raquo;';
