...
<body>
	...
	<div class="bodytitle">
		...
		<div class="bodytitletxt">用户推荐奖排行</div> 
	</div>
	<div>
...
<script type= "text/javascript" language ="javascript">
	$(window.parent.document).attr("title","用户推荐奖排行");
    ...
    {   
    	...
    	$("#PageInfo").html('');     
        var data = "action=get_commendedaward_rank";
	...
	function DataSuccess(json)
	{
		...
		$.each(json,function(i,item){
			...
			{
				if(InfoType == "get_commendedaward_rank")
                {
