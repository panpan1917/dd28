...
class payment
{
	...
	private $paymentUrl = "http://pay.eqianbao.cc/pay.htm";//充值支付
	private $PayCallBackUrl = "";
	
	private $drawUrl = "http://pay.eqianbao.cc/anotherpay.htm";//提现
	private $DrawCallBackUrl = "";
	
	private $checkChargeUrl = "http://pay.eqianbao.cc/osearch.htm";
    ...
    public function __construct() {
        ...
        $this->account[0]['MerchantNo'] = "20047";//杭州启信娱乐
        $this->account[0]['Key'] = "b9578230-d3bf-9132-78bc-874a9f264098";
        
        $this->account[1]['MerchantNo'] = "20029";//杭州宏丰商贸
        $this->account[1]['Key'] = "6666c38a-58d7-1234-9ed6-0bea9f222076";
        
        $this->account[2]['MerchantNo'] = "";
        $this->account[2]['Key'] = "";
    }
	...
	public function payRequest($PayType , $OrderNo , $Amount){
		$params['code'] = $this->MerchantNo;
		$params['attach'] = $this->MerchantNo . "_" . $OrderNo;
		$params['money'] = $Amount;
