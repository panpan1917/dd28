...
<body>
	...
	<div>
		<table class="tbtitle" width="99%" cellspacing="1" cellpadding="0" border="0" align="center" style="BACKGROUND: #cad9ea;" >				
			<tr bgcolor="#FFFFFF">
				<td><label id="lblUserIdx"></label>修改记录
		...
		<table class="tbtitle" width="99%" cellspacing="1" cellpadding="0" border="0" align="center" style="BACKGROUND: #cad9ea;" >
			<tr bgcolor="#FFFFFF">
			  ...
			  <td width="180">
				  <select id = "sltOrder">
						<option value="change_time">操作时间</option>
						<option value="detail_type">类型</option>
						<option value="uid">用户ID</option> 
						<option value="opr_user">操作人</option>
						<option value="item_old">原资料</option>
						<option value="item_new">新资料</option>
					</select>
					&nbsp;&nbsp;
...
<script type= "text/javascript" language ="javascript">
    ...
    //取记录
    function GetChangeDetailLogData()
    { 
        var data = GetData();
        SendAjax(data);
    }
    ...
    {   
    	...
    	$("#PageInfo").html('');     
        var data = "action=get_changedetaillog";
	...
	function DataSuccess(json)
	{
		...
		$.each(json,function(i,item){
			...
			{
				if(InfoType == "get_changedetaillog")
                {
