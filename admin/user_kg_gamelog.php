...
<body>
	...
	<div>
		<table class="tbtitle" width="99%" cellspacing="1" cellpadding="0" border="0" align="center" style="BACKGROUND: #cad9ea;" >				
			<tr bgcolor="#FFFFFF">
				<td><label id="lblUserIdx"></label>未开奖游戏记录
...
<script type= "text/javascript" language ="javascript">
	$(window.parent.document).attr("title","未开奖记录");
    ...
    {   
        ...
        if($("#cbxExceptInner").is(":checked"))
        	isExceptInner = 1;
        data += "&usertype=0&isexceptinner=" + isExceptInner;
