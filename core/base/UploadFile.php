...
class UploadFile {//类定义开始
    ...
    private function save($file) {
        ...
        if(!move_uploaded_file($file['tmp_name'], $this->autoCharset(KKROOT.$filename,'utf-8','gbk'))) {
            $this->error = '文件上传保存错误！';
            return false;
        }
    ...
    private function getSubName($file) {
        ...
        if(!is_dir($file['savepath'].$dir)) {
            echo $file['savepath'].$dir;
            create_folder(KKROOT.$file['savepath'].$dir);
        }
        return $dir;
    }
