...
include_once '../func/IELPMConfig.php';
?>
		...
		<div class="col-md-6 col-md-offset-3">
			<form role="form" action="payhandler.php" method="post"  name="payForm" >
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="notifyUrl" required>
		        </div>
			
		        <div class="form-group">
			        <label for="returnUrl">前台跳转地址</label>
			        <input type="text" class="form-control" name="returnUrl" required>
		        </div>
		        ...
		        <div class="form-group">
			        ...
			        <input type="text" class="form-control" name="buyerId" required>
		        </div>
